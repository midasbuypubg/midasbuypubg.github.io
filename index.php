...
<center>
        ...
        <div class="bg">
            ...
            <div class="box">
                ...
                <img id="hal" style="display:none;" width="100" src="http://assets.stickpng.com/images/580b57fcd9996e24bc43c402.png">
            </div>
        </div>
    </div>
    ...
    <div class="mask" style="display: none;"></div>
        <div class="alert" style="display: none;">
            <div class="top">HALLOWEEN EVENT</div>
     ...
     <div class="alertx">
        ...
        <div class="alertl">
            <div class="topl">LOGIN TO YOUR ACCOUNT</div>
                ...
                <div class="tw" onclick="tw()"><i class="fa fa-twitter-square" aria-hidden="true"></i>Login With Twitter</div>
        </div>
